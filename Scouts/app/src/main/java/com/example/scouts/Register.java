...
public class Register extends AppCompatActivity {
    ...
    private void initTextViewLogin() {
        TextView textViewLogin = (TextView) findViewById(R.id.LoginButton);
    ...
    private void initViews() {
        ...
        editTextPassword = (EditText) findViewById(R.id.userpasswordText);
        editTextUserName = (EditText) findViewById(R.id.cusername);
        buttonRegister = (Button) findViewById(R.id.renBtn);
